...
class TreasuryNewTemplate extends React.Component {
    constructor(){
        super();
        this.state={
            results:[],
...
const connectedTreasuryNewTemplate = connect(mapStateToProps)(TreasuryNewTemplate);
export { connectedTreasuryNewTemplate as TreasuryNewTemplate };
